	...
	sqpBackbone.views.questionImprovementView = Backbone.View.extend({
		...
		removeVars : [   // A list of vars never to show in potential improvements since they are not useful
			'concept', 'domain', 'socdesir', 'country', 'language', 'avgabs_intro', 'study', 'past', 'avgsy_total', 'avgwrd_total', 'avgabs_total', 'avgwrd_intro', 'nsyll_total','future', 'repetition', 'from', 'nnouns_tot', 'computer.assisted'
		],
