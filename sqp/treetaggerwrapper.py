...
alonemarks = u"!?¿;,\202*¤@°:%|¦/()[\]{}<>«»´`¨&~=#±\226"+\
             u"\227£¥$©®\""
g_langsupport = {
     "it": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "italian-utf8.par",
            "abbrevfile": "italian-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            ...
            "dummysentence": u"Questa pagina contiene una lista di voci che i wikipediani ritengono particolarmente complete .",
     ...
     "pt": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "pt.par",
            "abbrevfile": "portuguese-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"'(s|re|ve|d|m|em|ll)|n't",
            ...
            "dummysentence": u"O céu é azul e as rosas são vermelhas você é muito bonita, mas não deixe que ele suba à cabeça .",
            "replurlexp": ur' replaced-url <repurl text="\1" />',
            "replemailexp": ur' replaced-email <repemail text="\1" />',
            "replipexp" : ur' replaced-ip <repip text="\1" />',
            "repldnsexp" : ur' replaced-dns <repdns text="\1" />'
          },
     "gl": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "gz.par",
            "abbrevfile": "galician-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"'(s|re|ve|d|m|em|ll)|n't",
            ...
            "dummysentence": u"Oh ceo sobre o Océano Atlántico levar miña miseria e felicidade e espallalas lo polo seu augas interminables .",
            "replurlexp": ur' replaced-url <repurl text="\1" />',
            "replemailexp": ur' replaced-email <repemail text="\1" />',
            "replipexp" : ur' replaced-ip <repip text="\1" />',
            "repldnsexp" : ur' replaced-dns <repdns text="\1" />'
    ...
    "nl": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "dutch.par",
            "abbrevfile": "dutch-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"'(s|re|ve|d|m|em|ll)|n't",
            ...
            "dummysentence": u"Dit is een dummy zin om ervoor te zorgen gegevens te duwen .",
            "replurlexp": ur' replaced-url <repurl text="\1" />',
            "replemailexp": ur' replaced-email <repemail text="\1" />',
            "replipexp" : ur' replaced-ip <repip text="\1" />',
            "repldnsexp" : ur' replaced-dns <repdns text="\1" />'
    ...
    "es": { "binfile-win": "tree-tagger.exe",
       ...
       "ca": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "CatIEC_GLICOM_eagles.utf-8.par",
            "abbrevfile": "catalan-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"",
            ...
            "dummysentence": u"Vull donar les gràcies a vostè i explicar un malentès .",
            "replurlexp": ur' sustituir-url <repurl text="\1" />',
            "replemailexp": ur' sustituir-email <repemail text="\1" />',
            "replipexp" : ur' sustituir-ip <repdip text="\1" />',
            "repldnsexp" : ur' sustituir-dns <repdns text="\1" />'
...
#           },
        "ru": { "binfile-win": "tree-tagger.exe",
            ...
            "abbrevfile": "russian-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"",
            ...
            "dummysentence": u"Это фиктивный предложение для обеспечения данных толчок .",
            "replurlexp": ur' replaced-url <repurl text="\1" />',
            "replemailexp": ur' replaced-email <repemail text="\1" />',
            "replipexp" : ur' replaced-ip <repip text="\1" />',
            "repldnsexp" : ur' replaced-dns <repdns text="\1" />'
           },
        "et": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "estonian.par",
            "abbrevfile": "estonian-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"",
            ...
            "dummysentence": u"See on näiv lause, et tagada andmete push .",
            "replurlexp": ur' sustituir-url <repurl text="\1" />',
            "replemailexp": ur' sustituir-email <repemail text="\1" />',
            "replipexp" : ur' sustituir-ip <repdip text="\1" />',
            "repldnsexp" : ur' sustituir-dns <repdns text="\1" />'
           },
        "bg": { "binfile-win": "tree-tagger.exe",
            "binfile-lin": "tree-tagger",
            "binfile-darwin": "tree-tagger",
            "tagparfile": "bulgarian.par",
            "abbrevfile": "bulgarian-abbreviations",
            "pchar"     : alonemarks+ur"'",
            "fchar"     : alonemarks+ur"'",
            "pclictic"  : ur"",
            "fclictic"  : ur"",
            ...
            "dummysentence": u"В планината и гледам небето като една картина .",
            "replurlexp": ur' sustituir-url <repurl text="\1" />',
            "replemailexp": ur' sustituir-email <repemail text="\1" />',
            "replipexp" : ur' sustituir-ip <repdip text="\1" />',
            "repldnsexp" : ur' sustituir-dns <repdns text="\1" />'
