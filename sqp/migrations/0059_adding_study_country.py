...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Study.country'
        db.add_column('sqp_study', 'country', self.gf('django.db.models.fields.CharField')(max_length=70, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Study.country'
        db.delete_column('sqp_study', 'country')
