...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Prediction.pyblob'
        db.delete_column('sqp_prediction', 'pyblob')

        # Adding field 'Prediction.function_name'
        db.add_column('sqp_prediction', 'function_name', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Prediction.pyblob'
        db.add_column('sqp_prediction', 'pyblob', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Deleting field 'Prediction.function_name'
        db.delete_column('sqp_prediction', 'function_name')
