...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Study.company'
        db.add_column('sqp_study', 'company', self.gf('django.db.models.fields.CharField')(max_length=70, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Study.company'
        db.delete_column('sqp_study', 'company')
    ...
    models = {
        ...
        'sqp.study': {
            ...
            'company': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True'}),
            ...
            'year': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True'})
        },
        'sqp.usedcountry': {
