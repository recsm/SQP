...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field assignments on 'QuestionBulkAssignments'
        db.create_table('sqp_questionbulkassignments_assignments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionbulkassignments', models.ForeignKey(orm['sqp.questionbulkassignments'], null=False)),
            ('userquestion', models.ForeignKey(orm['sqp.userquestion'], null=False))
        ))
        db.create_unique('sqp_questionbulkassignments_assignments', ['questionbulkassignments_id', 'userquestion_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field assignments on 'QuestionBulkAssignments'
        db.delete_table('sqp_questionbulkassignments_assignments')
