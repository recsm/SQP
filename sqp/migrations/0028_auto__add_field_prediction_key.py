...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.key'
        db.add_column('sqp_prediction', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prediction.key'
        db.delete_column('sqp_prediction', 'key')
