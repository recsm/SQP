...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.key_expires'
        db.add_column('sqp_userprofile', 'key_expires', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2015, 4, 28)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.key_expires'
        db.delete_column('sqp_userprofile', 'key_expires')
