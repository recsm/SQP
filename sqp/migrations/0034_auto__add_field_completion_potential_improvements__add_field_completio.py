...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Completion.potential_improvements'
        db.add_column('sqp_completion', 'potential_improvements', self.gf('sqp.fields.PickledObjectField')(null=True, blank=True), keep_default=False)

        # Adding field 'Completion.authorized'
        db.add_column('sqp_completion', 'authorized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Completion.potential_improvements'
        db.delete_column('sqp_completion', 'potential_improvements')

        # Deleting field 'Completion.authorized'
        db.delete_column('sqp_completion', 'authorized')
