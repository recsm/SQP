...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sqp_item', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_item_set', null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('sqp_item', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_item_set', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Deleting field 'Item.created_by'
        db.delete_column('sqp_item', 'created_by_id')
