...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sqp_prediction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('paramater', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.Parameter'])),
            ('view', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.View'])),
            ('pyblob', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sqp', ['Prediction'])

        # Adding model 'View'
        db.create_table('sqp_view', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('output_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('sqp', ['View'])

        # Adding model 'Parameter'
        db.create_table('sqp_parameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sqp', ['Parameter'])


    def backwards(self, orm):
        
        # Deleting model 'Prediction'
        db.delete_table('sqp_prediction')

        # Deleting model 'View'
        db.delete_table('sqp_view')

        # Deleting model 'Parameter'
        db.delete_table('sqp_parameter')
    ...
    models = {
        ...
        'sqp.prediction': {
            ...
            'pyblob': ('django.db.models.fields.TextField', [], {}),
        ...
        'sqp.view': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'output_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
