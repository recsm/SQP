...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.owner'
        db.add_column('sqp_question', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_question_set', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Question.is_public'
        db.add_column('sqp_question', 'is_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Study.owner'
        db.add_column('sqp_study', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_study_set', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Study.is_public'
        db.add_column('sqp_study', 'is_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.owner'
        db.add_column('sqp_item', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_item_set', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Item.is_public'
        db.add_column('sqp_item', 'is_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.owner'
        db.delete_column('sqp_question', 'owner_id')

        # Deleting field 'Question.is_public'
        db.delete_column('sqp_question', 'is_public')

        # Deleting field 'Study.owner'
        db.delete_column('sqp_study', 'owner_id')

        # Deleting field 'Study.is_public'
        db.delete_column('sqp_study', 'is_public')

        # Deleting field 'Item.owner'
        db.delete_column('sqp_item', 'owner_id')

        # Deleting field 'Item.is_public'
        db.delete_column('sqp_item', 'is_public')

        # Changing field 'Item.name'
        db.alter_column('sqp_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Item.admin'
        db.alter_column('sqp_item', 'admin', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Item.long_name'
        db.alter_column('sqp_item', 'long_name', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        'sqp.item': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_item_set'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'sqp.question': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_question_set'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'sqp.study': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_study_set'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'sqp.usedcountry': {
