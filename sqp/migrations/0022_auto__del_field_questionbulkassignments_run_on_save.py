...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'QuestionBulkAssignments.run_on_save'
        db.delete_column('sqp_questionbulkassignments', 'run_on_save')


    def backwards(self, orm):
        
        # Adding field 'QuestionBulkAssignments.run_on_save'
        db.add_column('sqp_questionbulkassignments', 'run_on_save', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
