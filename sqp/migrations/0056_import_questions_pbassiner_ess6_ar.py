...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Q_BASE_DIR  = settings.PROJECT_DIR + '/data/questions_pbassiner_ess6_ar/'
        files = []
        ...
        log_file = codecs.open('/tmp/pbassiner_ess6_ar_import.log', 'w', "utf-8-sig")
        log_file.write(log_text)
        log_file.close()
        print "LOG STORED AT '/tmp/pbassiner_ess6_ar_import.log'"
