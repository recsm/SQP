...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sqp_question', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_question_set', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'UserProfile.is_trusted'
        db.add_column('sqp_userprofile', 'is_trusted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'Study.created_by'
        db.add_column('sqp_study', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_study_set', null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('sqp_question', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_question_set', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Deleting field 'Question.created_by'
        db.delete_column('sqp_question', 'created_by_id')

        # Deleting field 'UserProfile.is_trusted'
        db.delete_column('sqp_userprofile', 'is_trusted')

        # Adding field 'Study.owner'
        db.add_column('sqp_study', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_study_set', null=True, to=orm['auth.User'], blank=True), keep_default=False)
        ...
        # Deleting field 'Study.created_by'
        db.delete_column('sqp_study', 'created_by_id')
