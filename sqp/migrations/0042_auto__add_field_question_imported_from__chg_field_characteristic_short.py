...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.imported_from'
        db.add_column('sqp_question', 'imported_from', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True), keep_default=False)

        # Changing field 'Characteristic.short_name'
        db.alter_column('sqp_characteristic', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=32))


    def backwards(self, orm):
        
        # Deleting field 'Question.imported_from'
        db.delete_column('sqp_question', 'imported_from')

        # Changing field 'Characteristic.short_name'
        db.alter_column('sqp_characteristic', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=12))
