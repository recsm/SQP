...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        headers = False
        file = open(settings.PROJECT_DIR + '/data/codes/ESS-Round4-codes.csv', 'r')
        ...
        for line in file:
            ...
            try:
                ...
                user = User.objects.get(username__startswith=row['coder'])
                ...
                (row_study, row_country, row_language, row_item_name, row['coder'], e)
                print error
