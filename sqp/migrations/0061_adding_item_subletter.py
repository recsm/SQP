...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sqp_item','admin_letter', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True))

    def backwards(self, orm):
        
        # Deleting field 'Item.admin_subletter'
        db.delete_column('sqp_item', 'admin_subletter')
    ...
    models = {
        ...
        'sqp.item': {
            ...
            'admin_subletter': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
