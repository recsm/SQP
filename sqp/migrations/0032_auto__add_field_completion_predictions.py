...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Completion.predictions'
        db.add_column('sqp_completion', 'predictions', self.gf('sqp.fields.PickledObjectField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Completion.predictions'
        db.delete_column('sqp_completion', 'predictions')
