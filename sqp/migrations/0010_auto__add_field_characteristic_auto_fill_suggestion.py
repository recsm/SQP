...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Characteristic.auto_fill_suggestion'
        db.add_column('sqp_characteristic', 'auto_fill_suggestion', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Characteristic.auto_fill_suggestion'
        db.delete_column('sqp_characteristic', 'auto_fill_suggestion')
