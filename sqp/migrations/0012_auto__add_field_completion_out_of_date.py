...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Completion.out_of_date'
        db.add_column('sqp_completion', 'out_of_date', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Completion.out_of_date'
        db.delete_column('sqp_completion', 'out_of_date')
