...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sqp_history', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actor', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('action_description', self.gf('django.db.models.fields.TextField')()),
            ('action_type', self.gf('django.db.models.fields.IntegerField')()),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('object_model', self.gf('django.db.models.fields.CharField')(max_length=90)),
            ('object_name', self.gf('django.db.models.fields.CharField')(max_length=170)),
            ('previous_values', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sqp', ['History'])


    def backwards(self, orm):
        
        # Deleting model 'History'
        db.delete_table('sqp_history')
