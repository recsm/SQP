...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sqp_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('default_characteristic_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.CharacteristicSet'])),
        ))
        db.send_create_signal('sqp', ['UserProfile'])
      
  
    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('sqp_userprofile')
