...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'QuestionBulkAssignments.study'
        db.delete_column('sqp_questionbulkassignments', 'study_id')

        # Adding field 'QuestionBulkAssignments.item_group'
        db.add_column('sqp_questionbulkassignments', 'item_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.ItemGroup'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'QuestionBulkAssignments.study'
        db.add_column('sqp_questionbulkassignments', 'study', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.Study'], null=True, blank=True), keep_default=False)

        # Deleting field 'QuestionBulkAssignments.item_group'
        db.delete_column('sqp_questionbulkassignments', 'item_group_id')

        # Deleting field 'QuestionBulkAssignments.auto_create_questions'
        db.delete_column('sqp_questionbulkassignments', 'auto_create_questions')
    ...
    models = {
        ...
        'sqp.questionbulkassignments': {
            ...
            'auto_create_questions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sqp.Country']", 'null': 'True', 'blank': 'True'}),
            'has_been_run': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sqp.ItemGroup']", 'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sqp.Language']", 'null': 'True', 'blank': 'True'}),
