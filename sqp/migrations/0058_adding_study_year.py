...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Study.year'
        db.add_column('sqp_study', 'year', self.gf('django.db.models.fields.CharField')(max_length=70, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Study.year'
        db.delete_column('sqp_study', 'year')
