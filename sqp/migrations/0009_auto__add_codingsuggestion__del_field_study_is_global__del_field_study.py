...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CodingSuggestion'
        db.create_table('sqp_codingsuggestion', (
        ...
        db.send_create_signal('sqp', ['CodingSuggestion'])
        ...
        #Add indexes and modify our table as needed
        db.execute("ALTER TABLE `sqp_codingsuggestion` ADD UNIQUE `question_char` ( `characteristic_id` , `question_id` )") 
        db.execute("ALTER TABLE `sqp_codingsuggestion` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;")

    def backwards(self, orm):
        
        # Deleting model 'CodingSuggestion'
        db.delete_table('sqp_codingsuggestion')
        ...
        db.add_column('sqp_study', 'created_by_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_study_set', null=True, to=orm['auth.User'], blank=True), keep_default=False)
