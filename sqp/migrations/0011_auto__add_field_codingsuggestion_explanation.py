...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodingSuggestion.explanation'
        db.add_column('sqp_codingsuggestion', 'explanation', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CodingSuggestion.explanation'
        db.delete_column('sqp_codingsuggestion', 'explanation')
