...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sqp_userquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sqp.Question'])),
            ('can_edit_text', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_edit_details', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sqp', ['UserQuestion'])


    def backwards(self, orm):
        
        # Deleting model 'UserQuestion'
        db.delete_table('sqp_userquestion')
