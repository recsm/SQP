...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Language.available'
        db.add_column('sqp_language', 'available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Language.available'
        db.delete_column('sqp_language', 'available')
