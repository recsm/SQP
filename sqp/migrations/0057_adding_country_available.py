...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Country.available'
        db.add_column('sqp_country', 'available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.available'
        db.delete_column('sqp_country', 'available')
