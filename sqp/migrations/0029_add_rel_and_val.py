...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        val_sql = open(settings.PROJECT_DIR + '/data/val_create.sql').read()
        
        db.execute_many(val_sql)
        
        rel_sql = open(settings.PROJECT_DIR + '/data/rel_create.sql').read()
     
        db.execute_many(rel_sql)
        
     
        val_sql = open(settings.PROJECT_DIR + '/data/val.sql').read()
        
        db.execute_many(val_sql)
        
        rel_sql = open(settings.PROJECT_DIR + '/data/rel.sql').read()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Question.val'
        db.delete_column('sqp_question', 'val')

        # Deleting field 'Question.val_lo'
        db.delete_column('sqp_question', 'val_lo')

        # Deleting field 'Question.val_hi'
        db.delete_column('sqp_question', 'val_hi')

        # Deleting field 'Question.rel'
        db.delete_column('sqp_question', 'rel')

        # Deleting field 'Question.rel_lo'
        db.delete_column('sqp_question', 'rel_lo')

        # Deleting field 'Question.rel_hi'
        db.delete_column('sqp_question', 'rel_hi')
    ...
    models = {
        ...
        'sqp.question': {
            ...
            'rel': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'rel_hi': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'rel_lo': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'rfa_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'val': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'val_hi': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'val_lo': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
