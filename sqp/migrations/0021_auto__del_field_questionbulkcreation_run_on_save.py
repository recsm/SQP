...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'QuestionBulkCreation.run_on_save'
        db.delete_column('sqp_questionbulkcreation', 'run_on_save')


    def backwards(self, orm):
        
        # Adding field 'QuestionBulkCreation.run_on_save'
        db.add_column('sqp_questionbulkcreation', 'run_on_save', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
