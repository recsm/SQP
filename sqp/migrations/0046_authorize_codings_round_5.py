...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        headers = False
        file = open(settings.PROJECT_DIR + '/data/codes/ESS-Round5-codes.csv', 'r')
        ...
        study = sqp_models.Study.objects.get(name='ESS Round 5')
        questions = {}
        for line in file:
            ...
            if qkey not in questions.keys():
                ...
                #Clear any existing completion records
                sqp_models.Completion.objects.filter(user=user, 
