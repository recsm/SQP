...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        none_widget, created = sqp_models.Widget.objects.get_or_create(name='No Widget')
        none_widget.save()
        
        for char in add_on_chars:
            new_char, created = sqp_models.Characteristic.objects.get_or_create(name=char,
                                                            short_name=char,
                                                            desc='(auto added)',
                                                            widget=none_widget)
            new_char.save()
